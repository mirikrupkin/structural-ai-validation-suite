...
3. **Automated Construct Trimming & Heteroatom Stripping:** Intelligently prunes unaligned prediction tails, isolates matching reference chains, and strips out non-protein heteroatoms (waters, ions, ligands) to ensure clean 1-to-1 visual comparisons.
